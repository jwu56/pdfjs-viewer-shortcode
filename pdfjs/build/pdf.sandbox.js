...
/******/ var __webpack_modules__ = {
	...
	/***/ 283( module, __unused_webpack_exports, __webpack_require__ ) {
		...
		var CONFIGURABLE_FUNCTION_NAME = __webpack_require__( 350 )
			.CONFIGURABLE;
	...
	/***/ 1148(
		...
		var iteratorHelperWithoutClosingOnEarlyError = __webpack_require__(
			4549
		);
	...
	/***/ 4644( module, __unused_webpack_exports, __webpack_require__ ) {
		...
		var exportTypedArrayMethod = function(
			KEY,
			property,
			forced,
			options
		...
		for ( NAME in TypedArrayConstructorsList ) {
			...
			if ( Prototype )
				enforceInternalState( Prototype )[
	...
	/***/ 4979(
		...
		if (
			PolyfilledDOMExceptionPrototype.constructor !==
...
*/
	...
	/***/ 6632(
		...
		if ( Uint8Array )
			$(
				...
				{
					setFromBase64: function setFromBase64(
						string /* , options */
					) {
						anUint8Array( this );
	...
	/***/ 9577(
		...
		var getTypedArrayConstructor =
			ArrayBufferViewCore.getTypedArrayConstructor;
...
var web_dom_exception_stack = __webpack_require__( 4979 ); // ./external/quickjs/quickjs-eval.js
var Module = ( () => {
	var _scriptDir =
	...
	return function( moduleArg = {} ) {
		...
		function da( a, b ) {
			return ca()
				...
				.then( ( c ) => c )
				.then( b, ( c ) => {
					u( `failed to asynchronously prepare wasm: ${ c }` );
					w( c );
				} );
		}
		function ea( a, b ) {
		...
		var N = ( a ) => {
			...
			P = ( a, b ) => {
				...
				if ( 16 < e - b && a.buffer && O )
					return O.decode( a.subarray( b, e ) );
				for ( c = ''; b < e;  ) {
					var f = a[ b++ ];
					if ( f & 128 ) {
						var g = a[ b++ ] & 63;
		...
		var la = {
				a: ( a, b, c, e ) => {
					w(
						`Assertion failed: ${ a ? P( A, a ) : '' }, at: ` +
							[
								b ? ( b ? P( A, b ) : '' ) : 'unknown filename',
								c,
								e ? ( e ? P( A, e ) : '' ) : 'unknown function',
							]
					);
				},
				i: function( a, b, c ) {
					...
					B[ ( c + 32 ) >> 2 ] =
						( b != e &&
							a.getTimezoneOffset() == Math.min( e, b ) ) | 0;
				},
				d: ( a, b, c ) => {
					function e( t ) {
						return ( t = t
				...
				l: function( a, b, c, e ) {
					...
					c = c ? P( A, c ) : '';
					c = `Quickjs -- ${ a }: ${ b }\n${ c }`;
					0 !== e ? window.alert( c ) : window.console.error( c );
				},
			},
			X = ( function() {
				function a( c ) {
		...
		d._evalInSandbox = ( a, b ) => ( d._evalInSandbox = X.o )( a, b );
		d._nukeSandbox = () => ( d._nukeSandbox = X.p )();
		d._init = ( a, b ) => ( d._init = X.q )( a, b );
		d._commFun = ( a, b ) => ( d._commFun = X.r )( a, b );
		d._dumpMemoryUse = () => ( d._dumpMemoryUse = X.s )();
		var S = ( a ) => ( S = X.t )( a );
		d._free = ( a ) => ( d._free = X.u )( a );
		var W = () => ( W = X.w )(),
			ja = ( a ) => ( ja = X.x )( a ),
			V = ( a ) => ( V = X.y )( a );
		d.ccall = ka;
		d.cwrap = ( a, b, c, e ) => {
			var f =
				! c || c.every( ( g ) => 'number' === g || 'boolean' === g );
			return 'string' !== b && f && ! e
				? d[ '_' + a ]
				: function() {
						return ka( a, b, c, arguments, e );
				  };
		};
		d.stringToNewUTF8 = T;
		var Z;
...
/* harmony default export */ const quickjs_eval = Module; // ./src/pdf.sandbox.external.js
	...
	createSandboxExternals() {
		const externals = {
			...
			prompt: ( cQuestion, cDefault ) => {
				if (
					typeof cQuestion !== 'string' ||
					typeof cDefault !== 'string'
				) {
					return null;
				}
